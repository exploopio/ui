...
import type { TenantSubscription } from '@/features/licensing/api/use-subscription'
...
/**
 * Get subscription from bootstrap
 */
export function useBootstrapSubscription() {
  ...
  return {
    ...
    isActive: data?.subscription?.status === 'active' || data?.subscription?.status === 'trial',
    isLoading,
  }
}

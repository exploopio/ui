  ...
  const handleSaveSecurity = async () => {
    try {
      ...
      const result = await updateSecuritySettings({
        ...
        sso_provider: securityForm.sso_provider,
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSecurityForm({ ...securityForm, sso_enabled: checked })
                    }
                    disabled={!canUpdateTenant}
                  />
                </div>

                {securityForm.sso_enabled && (
                  <div className="space-y-2 pl-4 border-l-2 border-muted">
                    <Label>SSO Provider</Label>
                    <Select
                      value={securityForm.sso_provider}
                      onValueChange={(value) =>
                        setSecurityForm({ ...securityForm, sso_provider: value })
                      }
                      disabled={!canUpdateTenant}
                    >

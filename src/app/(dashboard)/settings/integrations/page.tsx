        ...
        <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl text-green-500">{integrationStats.connected}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Connect more tools to enhance your security operations</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>

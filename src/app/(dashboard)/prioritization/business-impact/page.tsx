...
const complianceFrameworks = [
  ...
  { name: "ISO 27001", status: "Compliant", issues: 1, deadline: "Annual", color: "text-green-400" },
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl text-red-500">{impactMetrics.totalFinancialRisk}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl text-orange-500">{impactMetrics.regulatoryExposure}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl text-yellow-500">{impactMetrics.reputationRisk}</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                {businessUnits.map((unit) => {
                  ...
                  return (
                    <TableRow key={unit.name} className="cursor-pointer hover:bg-muted/50">
                      ...
                      <TableCell>
                        <Badge className={`${riskConfig.bgColor} ${riskConfig.color} border-0 capitalize`}>
                          {unit.riskLevel}
                        </Badge>
                      </TableCell>
                    </TableRow>

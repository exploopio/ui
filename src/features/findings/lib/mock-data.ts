  ...
  activities: [
    {
      ...
      newValue: "resolved",
      content:
        "Verified fix in production. WordPress updated to 6.3.2 on all affected servers.",
    ...
    },
    {
      ...
      newValue: "medium",
      reason:
        "Affects user PII exposure, upgrading severity based on impact assessment",
      createdAt: daysAgo(2),
    },
    {
      id: "act-005",
...
export const mockFindings: Finding[] = [
  {
    ...
    title: "WordPress Core - Post Author Email Disclosure",
    description:
      "WordPress Core is vulnerable to Sensitive Information Exposure...",
    severity: "medium",
    status: "confirmed",
    cvss: 5.3,
    cvssVector: "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N",
  ...
  },
  {
    ...
    description:
      "Critical SQL injection vulnerability found in the search functionality...",
    severity: "critical",
    status: "in_progress",
    cvss: 9.8,
  ...
  },
  {
    ...
    description:
      "Insecure Direct Object Reference allows accessing other users profiles...",
    severity: "high",
    status: "confirmed",
    cvss: 6.5,
    cwe: "CWE-639",
    assets: [
      { id: "asset-009", type: "service", name: "api.company.vn/v1/users" },
    ],
    evidence: [],
    remediation: {
  ...
  // Mobile App Findings
  {
    ...
    description:
      "Sensitive data is stored in plain text on device storage without encryption...",
    severity: "critical",
    status: "new",
    cvss: 8.6,
    cwe: "CWE-922",
    ...
    evidence: [],
    remediation: {
      description: "Implement secure storage using Keychain (iOS) or EncryptedSharedPreferences (Android)",
      steps: [],
      references: [],
      progress: 0,
    },
  ...
  },
  {
    ...
    description:
      "API keys and secrets are hardcoded in the mobile application source code...",
    severity: "high",
    status: "confirmed",
    cvss: 7.5,
    cwe: "CWE-798",
  ...
  },
  {
    ...
    description:
      "Production mobile app build has debug mode enabled, exposing sensitive logs...",
    severity: "medium",
    status: "in_progress",
    cvss: 4.3,
    cwe: "CWE-215",
...
export const getActiveFindingsCount = (): number => {
  return mockFindings.filter(
    (f) =>
      !["resolved", "verified", "closed", "duplicate", "false_positive"].includes(
        f.status
      )
  ).length;
};
